...
```ini
[masters]
master-01 ansible_host=192.168.68.70 rke2_type=server
master-02 ansible_host=192.168.68.71 rke2_type=server
master-03 ansible_host=192.168.68.72 rke2_type=server

[workers]
worker-01 ansible_host=192.168.68.73 rke2_type=agent
worker-02 ansible_host=192.168.68.74 rke2_type=agent
worker-03 ansible_host=192.168.68.75 rke2_type=agent
